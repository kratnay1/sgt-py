...
Welcome to Sgt-Py_'s documentation! Sgt-Py is a python package for performing group theoretic calculations with crystallographic space groups that interfaces with several functions from the `Bilbao Crystallographic Server`_.
