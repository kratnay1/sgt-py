...
Sgt-Py_ is a python package for performing group theoretic calculations with crystallographic space groups.  It provides an interface with several functions from the `Bilbao Crystallographic Server`_.
